...
CREATE INDEX IF NOT EXISTS idx_subject_attendance_class_subject_date ON subject_attendance(class_code, subject_code, date);
...
INSERT OR IGNORE INTO teacher_accounts (code, name, subject_code, teacher_name, allowed_classes, sort_order, pin) VALUES ('PJOK', 'PJOK', 'PJOK', 'Guru PJOK', '1A,1B,2A,2B,3A,3B,4A,4B,5A,5B,6A,6B', 1, '123456');
INSERT OR IGNORE INTO teacher_accounts (code, name, subject_code, teacher_name, allowed_classes, sort_order, pin) VALUES ('PAI1', 'PAI 1', 'PAI1', 'Guru PAI 1', '1A,1B,2A,2B,3A,3B', 2, '123456');
INSERT OR IGNORE INTO teacher_accounts (code, name, subject_code, teacher_name, allowed_classes, sort_order, pin) VALUES ('PAI2', 'PAI 2', 'PAI2', 'Guru PAI 2', '4A,4B,5A,5B,6A,6B', 3, '123456');
